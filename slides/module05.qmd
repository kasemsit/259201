...
## Flowchart คืออะไร? {#m5-flowchart}
...
::: {.callout-note}
ทบทวน: [List และ collection (Module 4)](module04.html#m4-list)
:::
...
::: {.callout-note}
ทบทวน: [Logical Operators (Module 3)](module03.html#m3-logical)
:::
...
# คำสั่ง if-else {background-color="#2c3e50" .white-text}

สองทางเลือก

## การใช้คำสั่ง if-else {#m5-if-else}


:::: {.columns}
::: {.column width="50%"}
![](images/m5-if-else-2.png){height="460px" fig-align="center" .fragment} 
:::
::: {.column width="50%"}
![](images/m5-if-else-1.png){height="460px" fig-align="center" .fragment}
:::
...
::: {.callout-note}
ทบทวน: [f-string format `{c:.2f}` (Module 3)](module03.html#m3-fstring-format)
:::
...
## การใช้คำสั่ง if-elif-else {#m5-if-elif-else}

:::: {.columns}
::: {.column width="50%"}
![](images/m5-if-elif-else-2.png){height="460px" fig-align="center" .fragment}
:::
::: {.column width="50%"}
![](images/m5-if-elif-else-1.png){height="460px" fig-align="center" .fragment}
:::
::::
...
## ข้อสังเกต: ตัดสินใจเป็นชั้น ๆ {#m5-elif-layered}
...
## การใช้คำสั่ง Nested if {#m5-nested-if}

:::: {.columns}
::: {.column width="50%"}
![](images/m5-nested-if-2.png){height="460px" fig-align="center"}
:::
::: {.column width="50%"}
![](images/m5-nested-if-1.png){height="460px" fig-align="center"}
:::
::::
...
ทบทวน: [input().split() (Module 3)](module03.html#m3-split) · [Logical operators `and` (Module 3)](module03.html#m3-logical)
:::
...
## โจทย์ #10: ชวนคิดอีก {.exercise-think}
...
::: {.callout-note}
ทบทวน: [Operator precedence (Module 3)](module03.html#m3-precedence) · [Arithmetic `%` `/` (Module 3)](module03.html#m3-arithmetic)
:::
