# Cross-Reference Map — Slide Dependencies

Use this to add review links when converting modules.
Link format: `[ทบทวน: topic](moduleNN.html#slide-id)`

## Module 3 Slide IDs

| ID | Topic |
|:---|:------|
| `m3-variables` | ตัวแปร (Variables) |
| `m3-identifier` | กฎการตั้งชื่อ |
| `m3-data-types` | ชนิดข้อมูล str/int/float/bool, `type()` |
| `m3-string-quote` | String quotes ('/"/'') |
| `m3-escape` | Escape code (\n, \t) |
| `m3-dynamic-typing` | Dynamic typing, `type()` |
| `m3-type-conversion` | `int()`, `float()`, `str()` |
| `m3-arithmetic` | +, -, *, /, //, %, ** |
| `m3-comparison` | >, <, ==, !=, >=, <= |
| `m3-logical` | and, or, not |
| `m3-assignment` | =, +=, -=, *=, /= |
| `m3-precedence` | Operator precedence |
| `m3-math` | math module (sqrt, sin, cos, pi) |
| `m3-input` | input() |
| `m3-split` | input().split() |
| `m3-fstring` | f-string basics |
| `m3-fstring-format` | f-string format specifiers (:.2f, :5) |
