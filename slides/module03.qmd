...
format:
  live-revealjs:
    ...
    margin: 0.08
    logo: ""
    footer: "259201 — Module 3 | ภาควิชาวิศวกรรมคอมพิวเตอร์ คณะวิศวกรรมศาสตร์ มหาวิทยาลัยเชียงใหม่"
...
| Code | ผลลัพธ์ | | Code | ผลลัพธ์ |
|:----:|:--------|---|:----:|:--------|
| `\n` | ขึ้นบรรทัดใหม่ | | `\'` | single quote |
| `\t` | แท็บ | | `\"` | double quote |
| `\\` | backslash | | | |
...
แสดงค่าและตรวจสอบ type — **คิดก่อน:** `s2` จะเป็นชนิดใด?
