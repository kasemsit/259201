...
## เห็นภาพ: modulo ตัดลูปเดียวเป็นตาราง {#m6-modulo-wrap-viz}

ลูปเดียว (`i = 1..12`) พิมพ์ต่อกันเป็นแถว — ทุกครั้งที่ `i % 5 == 0` → `print()` **ขึ้นบรรทัดใหม่**

```{=html}
<svg viewBox="0 0 620 150" width="100%" style="max-width:900px" xmlns="http://www.w3.org/2000/svg" font-family="monospace" font-size="16">
  <!-- group 1: i=1..5 -->
  <rect x="18" y="48" width="45" height="46" rx="6" fill="#eaf2f8" stroke="#7f8c8d" stroke-width="2"/><text x="40" y="40" text-anchor="middle" fill="#8e44ad" font-size="11">i=1</text><text x="40" y="78" text-anchor="middle">4</text>
  <rect x="67" y="48" width="45" height="46" rx="6" fill="#eaf2f8" stroke="#7f8c8d" stroke-width="2"/><text x="89" y="40" text-anchor="middle" fill="#8e44ad" font-size="11">i=2</text><text x="89" y="78" text-anchor="middle">8</text>
  <rect x="116" y="48" width="45" height="46" rx="6" fill="#eaf2f8" stroke="#7f8c8d" stroke-width="2"/><text x="138" y="40" text-anchor="middle" fill="#8e44ad" font-size="11">i=3</text><text x="138" y="78" text-anchor="middle">12</text>
  <rect x="165" y="48" width="45" height="46" rx="6" fill="#eaf2f8" stroke="#7f8c8d" stroke-width="2"/><text x="187" y="40" text-anchor="middle" fill="#8e44ad" font-size="11">i=4</text><text x="187" y="78" text-anchor="middle">16</text>
  <rect x="214" y="48" width="45" height="46" rx="6" fill="#eaf2f8" stroke="#e74c3c" stroke-width="3"/><text x="236" y="40" text-anchor="middle" fill="#8e44ad" font-size="11">i=5</text><text x="236" y="78" text-anchor="middle">20</text>
  <!-- group 2: i=6..10 -->
  <rect x="263" y="48" width="45" height="46" rx="6" fill="#eafaf1" stroke="#7f8c8d" stroke-width="2"/><text x="285" y="40" text-anchor="middle" fill="#8e44ad" font-size="11">i=6</text><text x="285" y="78" text-anchor="middle">24</text>
  <rect x="312" y="48" width="45" height="46" rx="6" fill="#eafaf1" stroke="#7f8c8d" stroke-width="2"/><text x="334" y="40" text-anchor="middle" fill="#8e44ad" font-size="11">i=7</text><text x="334" y="78" text-anchor="middle">28</text>
  <rect x="361" y="48" width="45" height="46" rx="6" fill="#eafaf1" stroke="#7f8c8d" stroke-width="2"/><text x="383" y="40" text-anchor="middle" fill="#8e44ad" font-size="11">i=8</text><text x="383" y="78" text-anchor="middle">32</text>
  <rect x="410" y="48" width="45" height="46" rx="6" fill="#eafaf1" stroke="#7f8c8d" stroke-width="2"/><text x="432" y="40" text-anchor="middle" fill="#8e44ad" font-size="11">i=9</text><text x="432" y="78" text-anchor="middle">36</text>
  <rect x="459" y="48" width="45" height="46" rx="6" fill="#eafaf1" stroke="#e74c3c" stroke-width="3"/><text x="481" y="40" text-anchor="middle" fill="#8e44ad" font-size="10">i=10</text><text x="481" y="78" text-anchor="middle">40</text>
  <!-- group 3: i=11..12 -->
  <rect x="508" y="48" width="45" height="46" rx="6" fill="#fef9e7" stroke="#7f8c8d" stroke-width="2"/><text x="530" y="40" text-anchor="middle" fill="#8e44ad" font-size="10">i=11</text><text x="530" y="78" text-anchor="middle">44</text>
  <rect x="557" y="48" width="45" height="46" rx="6" fill="#fef9e7" stroke="#7f8c8d" stroke-width="2"/><text x="579" y="40" text-anchor="middle" fill="#8e44ad" font-size="10">i=12</text><text x="579" y="78" text-anchor="middle">48</text>
  <!-- newline markers -->
  <text x="236" y="112" text-anchor="middle" fill="#e74c3c" font-weight="bold">↵</text><text x="236" y="128" text-anchor="middle" fill="#e74c3c" font-size="11">i%5==0</text>
  <text x="481" y="112" text-anchor="middle" fill="#e74c3c" font-weight="bold">↵</text><text x="481" y="128" text-anchor="middle" fill="#e74c3c" font-size="11">i%5==0</text>
</svg>
```

🔵 แถว 1 (i=1-5) · 🟢 แถว 2 (i=6-10) · 🟡 แถว 3 (i=11-12) — ลูป **มิติเดียว** ถูก `i % 5 == 0` ตัดเป็น **ตาราง 3 แถว**
...
## เห็นภาพ: 2 กับดักของลูป `while` {#m6-loop-traps}

:::: {.columns}
::: {.column width="50%"}

**กับดัก 1 — `False` ตั้งแต่แรก → ไม่เข้าลูป** (โจทย์ #5)

```{=html}
<svg viewBox="0 0 240 215" width="100%" style="max-width:300px" xmlns="http://www.w3.org/2000/svg" font-family="monospace" font-size="13">
  <defs><marker id="tk1" markerWidth="9" markerHeight="9" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#e74c3c"/></marker></defs>
  <polygon points="110,12 175,42 110,72 45,42" fill="#fdebd0" stroke="#7f8c8d" stroke-width="2"/>
  <text x="110" y="46" text-anchor="middle">x &gt; 10 ?</text>
  <text x="110" y="92" text-anchor="middle" fill="#e74c3c" font-weight="bold">x = 5 → False</text>
  <line x1="110" y1="72" x2="110" y2="104" stroke="#bdc3c7" stroke-width="2" stroke-dasharray="4 3"/>
  <rect x="45" y="106" width="130" height="42" rx="6" fill="#f4f6f7" stroke="#bdc3c7" stroke-width="2" stroke-dasharray="4 3"/>
  <text x="110" y="126" text-anchor="middle" fill="#95a5a6">งานในลูป</text>
  <text x="110" y="141" text-anchor="middle" fill="#95a5a6" font-size="11">(ไม่ถูกเรียก)</text>
  <rect x="45" y="170" width="130" height="36" rx="6" fill="#eaf2f8" stroke="#7f8c8d" stroke-width="2"/>
  <text x="110" y="192" text-anchor="middle">next-statement</text>
  <path d="M175,42 H212 V188 H178" fill="none" stroke="#e74c3c" stroke-width="2.5" marker-end="url(#tk1)"/>
  <text x="182" y="36" fill="#e74c3c" font-weight="bold">ข้าม</text>
</svg>
```

เงื่อนไขเป็นเท็จทันที → **ข้ามงานในลูปทั้งหมด**

:::
::: {.column width="50%"}

**กับดัก 2 — `True` เสมอ → วนไม่จบ** (โจทย์ #6)

```{=html}
<svg viewBox="0 0 300 180" width="100%" style="max-width:400px" xmlns="http://www.w3.org/2000/svg" font-family="monospace" font-size="13">
  <defs><marker id="tk2" markerWidth="9" markerHeight="9" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#e74c3c"/></marker></defs>
  <line x1="25" y1="88" x2="290" y2="88" stroke="#2c3e50" stroke-width="2"/>
  <g fill="#2c3e50" font-size="12" text-anchor="middle">
    <text x="55" y="108">-2</text><text x="95" y="108">-1</text><text x="135" y="108">0</text><text x="175" y="108">1</text><text x="215" y="108">…</text>
  </g>
  <circle cx="55" cy="88" r="4" fill="#2980b9"/><circle cx="95" cy="88" r="4" fill="#2980b9"/><circle cx="135" cy="88" r="4" fill="#2980b9"/><circle cx="175" cy="88" r="5" fill="#27ae60"/>
  <text x="175" y="48" text-anchor="middle" fill="#27ae60" font-weight="bold">เริ่ม x=1</text>
  <line x1="175" y1="58" x2="175" y2="80" stroke="#27ae60" stroke-width="2"/>
  <line x1="170" y1="72" x2="140" y2="72" stroke="#e74c3c" stroke-width="2" marker-end="url(#tk2)"/>
  <line x1="130" y1="72" x2="100" y2="72" stroke="#e74c3c" stroke-width="2" marker-end="url(#tk2)"/>
  <line x1="90" y1="72" x2="60" y2="72" stroke="#e74c3c" stroke-width="2" marker-end="url(#tk2)"/>
  <text x="112" y="62" text-anchor="middle" fill="#e74c3c" font-size="12">x -= 1</text>
  <line x1="262" y1="55" x2="262" y2="118" stroke="#e74c3c" stroke-width="3"/>
  <text x="262" y="135" text-anchor="middle" fill="#e74c3c" font-size="11">ต้อง x≥10</text>
  <text x="262" y="150" text-anchor="middle" fill="#e74c3c" font-size="11">ถึงจะหยุด</text>
  <text x="120" y="170" text-anchor="middle" fill="#e74c3c" font-weight="bold">วิ่งออกห่าง → ไม่มีวันถึง!</text>
</svg>
```

`x -= 1` ทำให้ `x` วิ่ง**ห่าง**จากเงื่อนไข → ลูปไม่จบ
